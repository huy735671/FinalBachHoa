...
const style = StyleSheet.create({
  ...
  UserInfoContainer: {
    ...
    // Adjust the spacing between buttons and user information
  },
  WhiteBackground: {
    backgroundColor: 'white',
    padding: 10,
